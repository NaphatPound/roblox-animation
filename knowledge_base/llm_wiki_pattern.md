...
## Summary
The "LLM Wiki" pattern addresses the inefficiency of traditional RAG (Retrieval-Augmented Generation) by shifting to a persistent, compounding, LLM-maintained collection of structured Markdown files (a Wiki). Instead of rediscovering knowledge for every query, the LLM incrementally integrates new sources, updates entity pages, and flags contradictions, creating a knowledge base that gets richer over time.
